<nav x-data="{ open: false }" class="bg-green-50 border-b border-green-300 shadow-md">
        ...
        <div class="flex justify-between items-center h-16">
            <div class="flex items-center">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="hover:text-green-600 transition duration-200">
                        {{ __('Homepage') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('search')" :active="request()->routeIs('search')" class="hover:text-green-600 transition duration-200">
                        {{ __('Search') }}
                    </x-nav-link>
                </div>
            </div>
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link :href="route('logout')"
                                    onclick="event.preventDefault();
                                                this.closest('form').submit();" class="hover:bg-green-100">
                                {{ __('Log Out') }}
                            </x-dropdown-link>
                        </form>
                    </x-slot>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-500 hover:text-gray-600 hover:bg-green-100 focus:outline-none focus:bg-green-100 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="hover:bg-green-100">
                {{ __('Homepage') }}
            ...
            <x-responsive-nav-link :href="route('search')" :active="request()->routeIs('search')" class="hover:bg-green-100">
            {{ __('Search') }}
            </x-responsive-nav-link>
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-green-200">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('profile.edit')" class="hover:bg-green-100">
                    {{ __('Profile') }}
                </x-responsive-nav-link>
