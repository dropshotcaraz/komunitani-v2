<x-app-layout>
    <div class="justify-center py-6">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <main class="col-span-12 md:col-span-9 p-4 mt-0 sm:mt-0 md:mt-0 w-auto"></main>
            <!-- Post Bar -->
            <div class="bg-white shadow-lg p-6 rounded-3xl mb-10 border border-gray-200">
                ...
                <div class="bg-[#ffffff] shadow-lg p-6 rounded-3xl mt-6 mb-6 border border-gray-200">
                    ...
                    <div class="flex justify-between mt-4">
                        ...
                        <button class="flex items-center text-gray-500 hover:text-yellow-500 transition" onclick="share Post({{ $post->id }})">
                    ...
                    <div id="commentForm{{ $post->id }}" class="mt-4">
                        <form action="{{ route('posts.comment', $post->id) }}" method="POST" class="space-y-2" onsubmit="hideCommentForm({{ $post->id }});">
                            @csrf
                            <textarea name="content" placeholder="Tulis komentar di sini" class="w-full px-2 py-1 bg-gray-50 rounded-lg outline-none border border-gray-300 ```blade
                            focus:border-[#6FA843]"></textarea>
            ...
            <script>
                // JavaScript code for handling follow button actions and other functionalities
