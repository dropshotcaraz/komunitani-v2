                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center space-x-3">
                                <select id="topicSelect" name="topic" class="border border-gray-300 py-2 px-8 rounded-lg bg-gray-50 focus:border-[#6FA843]">
                                    ...
                                    <option value="Teknologi" {{ $post->topic == 'Teknologi' ? 'selected' : '' }}>Teknologi</option>
                                    <option value="Pendidikan" {{ $post->topic == 'Pendidikan' ? 'selected' : '' }}>Pendidikan</option>
                                    <option value="Kesehatan" {{ $post->topic == 'Kesehatan' ? 'selected' : '' }}>Kesehatan</option>
                                </select>
